...
def predict():
	...
	gk15=float(request.form.get("physic",""))
	gk16=float(request.form.get("mentality_vision",""))
	gk17=float(request.form.get("attacking_short_passing",""))
	gk18=float(request.form.get("shooting",""))
	features=[gk1,gk2,gk3,gk4,gk5,gk6,gk7,gk8,gk9,gk10,gk11,gk12,gk13,gk14,gk15,gk16,gk17,gk18]
